<x-layout>
    <form method="POST" action="/songs/create" class="md:px-52 sm:px-52 py-8 mt-14" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2 ">
            <div>
                ...
                <input type="text" id="title"
                    ...
                    name="title" placeholder="lose yourself" required value="{{ old('title') }}" />
                @error('title')
            ...
            <div>
                ...
                <input type="text" id="artists"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="artists" placeholder="eminem" required value="{{ old('artists') }}" />
                @error('artists')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="text" id="writers"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="writers" placeholder="eminem" required value="{{ old('writers') }}" />
                @error('writers')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="text" id="languages"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="languages" placeholder="en" required value="{{ old('languages') }}" />
                @error('languages')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="number" id="duration"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="duration" placeholder="Lorem ipsum dolor sit amet" required value="{{ old('duration') }}" />
                @error('duration')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input type="date" id="release_date"
                    ...
                    required value="{{ old('release_date') }}" />
                @error('release_date')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input
                    ...
                    name="cover_image" id="cover_image" type="file"value="{{ old('cover_image') }}" />
                @error('cover_image')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
            <div>
                ...
                <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                    name="song_file" id="song_file" type="file"value="{{ old('song_file') }}" />
                @error('song_file')
                    <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
        ...
        <div class="mb-4">
            ...
            <textarea rows="4"
                ...
                name="lyrics" id="lyrics" placeholder="Write your lyrics here...">{{ old('lyrics') }}
            </textarea>
            @error('lyrics')
                <p class="text-red-600 text-xs mt-1">{{ $message }}</p>
            @enderror
